...
export default function MyTimer({ expiryTimestamp, secondTime, minuteTime, finish, setFinish, student, timed, setTimed, timeClick, edit, isTimed, setIsTimed, questionColor, setTimeClick }) {
    const {
      seconds,
      minutes,
      hours,
